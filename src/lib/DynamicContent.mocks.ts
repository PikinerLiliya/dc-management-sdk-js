...
export const HUB = {
  ...
  _links: {
    ...
    'list-content-type-schemas': {
      href:
        'https://api.amplience.net/v2/content/hubs/5b32377e4cedfd01c45036d8/content-type-schemas{?page,size,sort}',
      templated: true
    },
    'create-content-type-schema': {
      href:
        'https://api.amplience.net/v2/content/hubs/5b32377e4cedfd01c45036d8/content-type-schemas'
    },
    'resolve-content-type-schema': {
      href:
        'https://api.amplience.net/v2/content/hubs/5b32377e4cedfd01c45036d8/content-type-schemas/resolve'
    },
